# Agent Instructions for Nyayasetu

## Project Context
Nyayasetu is an open source Legal aid for underserved populations and rights awareness.

## Repository Layout
- `src/aumai_nyayasetu/` — package source
