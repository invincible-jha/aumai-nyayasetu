# Contributing to AumAI Nyayasetu
...
### Setup
```bash
git clone https://github.com/aumai/aumai-nyayasetu.git
cd aumai-nyayasetu
python -m venv .venv
...
### Good First Issues
New to the project? Start with issues labeled [`good first issue`](https://github.com/aumai/aumai-nyayasetu/labels/good%20first%20issue).
...
- [GitHub Discussions](https://github.com/aumai/aumai-nyayasetu/discussions)
