...
> Legal aid for underserved populations and rights awareness
...
- Core functionality (see docs for details)
...
Nyayasetu operates as a standalone tool. For enterprise-grade governance, connect to AumOS.
